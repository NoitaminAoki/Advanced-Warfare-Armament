package advancedwarfare.expand.block.drawer;
...
import advancedwarfare.content.AWContent;

public class DrawMissilePathSequence extends DrawPart{
    ...
    public DrawMissilePathSequence(String arrowName){
    ...
    public void draw(PartParams params){
        ...
        TextureRegion arrowRegion = AWContent.missilePathRegion;
    ...
    public void load(String name){
        ...
        }else arrowRegion = AWContent.missilePathRegion;
    }
